...
| tabs : Knd s -> Exp (s,X) -> Exp s
| tapp : Exp s -> Ty s -> Exp s
| kabs : Exp (s,K) -> Exp s
| kapp : Exp s -> Knd s -> Exp s
...
| .kabs a0, f => .kabs (a0.rename f.lift)
| .kapp a0 a1, f => .kapp (a0.rename f) (a1.rename f)
...
theorem Exp.rename_id {t : Exp s} :
  ...
  case app =>
    simp_all [Exp.rename]
  case tabs =>
    simp_all [Exp.rename, Knd.rename_id, Rename.lift_id]
  case tapp =>
    simp_all [Exp.rename, Ty.rename_id]
  case kabs =>
    simp_all [Exp.rename, Rename.lift_id]
  case kapp =>
    simp_all [Exp.rename, Knd.rename_id]
  case pair =>
    simp_all [Exp.rename]
  case fst =>
    simp_all [Exp.rename]
...
theorem Exp.rename_comp {t : Exp s1} {f : Rename s1 s2} {g : Rename s2 s3} :
  ...
  case app =>
    simp_all [Exp.rename]
  case tabs =>
    simp_all [Exp.rename, Knd.rename_comp, Rename.lift_comp]
  case tapp =>
    simp_all [Exp.rename, Ty.rename_comp]
  case kabs =>
    simp_all [Exp.rename, Rename.lift_comp]
  case kapp =>
    simp_all [Exp.rename, Knd.rename_comp]
  case pair =>
    simp_all [Exp.rename]
  case fst =>
    simp_all [Exp.rename]
